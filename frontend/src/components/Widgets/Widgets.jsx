...
export const ResetPasswordWidget = ({ isVisible, email }) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex items-center justify-center h-screen">
        <div className="flex flex-col w-1/3 h-44 p-6 justify-center items-center text-[#5F6D7E] font-[Inter] gap-3 bg-[#E9EBF1] border border-gray-300 rounded-lg shadow-xsm relative">
          ...
          <button className="bg-[#4CAF4F] px-2 font-extrabold text-[#2E3847] py-1  rounded-md">
            Continue
          </button>
        </div>
      </div>
...
export const SignUpSuccessfulWidget = ({ isVisible, email }) => {
  return (
    <div
      className={`fixed top-0 left-0 right-0 bottom-0 z-50 flex items-center justify-center ${
        isVisible ? 'visible' : 'hidden'
...
export const EmailVerificationWidget = ({ isVisible, email }) => {
  return (
    <div
      className={`fixed top-0 left-0 right-0 bottom-0 z-50 flex items-center justify-center ${
        isVisible ? 'visible' : 'hidden'
        ...
        <div className="flex flex-col w-1/3 h-44 p-6 justify-center items-center text-[#5F6D7E] font-[Inter] gap-3 bg-[#E9EBF1] border border-gray-300 rounded-lg shadow-xsm relative">
          ...
          <div className="flex flex-col text-center">
            <p className=" text-xs text-slate-500">
              ...
              <span className="text-[#172233]">workemail@work.com.</span> Kindly
              check <br /> your inbox to confirm your registration
            </p>
          </div>
