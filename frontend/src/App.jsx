  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/signup/security-question" element={<SignUpSecurityQuestion />} />
        <Route path="/resetpassword/security-question" element={<ResetPassSecQues />} />
        <Route path="/forgotpassword" element={<ForgotPassword />} />
        <Route path="/resetpassword" element={<ResetPassword />} />
        <Route path="/login" element={<Login />} />
        <Route path="/dashboard" element={<Dashboard />} />
        <Route path="/dashboard/analytics" element={<GeneralAnalytics />} />
        <Route path="/dashboard/application-details" element={<ApplicationDetails />} />
        ...
        <Route path="/applications/rejected" element={<RejectedApplications />} />
        <Route path="/applications/pending" element={<PendingApplications />} />
        <Route path="/applications/new-application/prediction" element={<InitialPredicion />} />
        <Route path="/applications/new-application/personalinfo" element={<NewAppContact />} />
        <Route path="/applications/new-application/loaninfo" element={<NewAppLoanInfo />} />
        <Route path="/applications/new-application/history" element={<NewAppFinHistory />} />
        <Route path="/applications/applicant/contact" element={<ApplicantContactInfo />} />
        <Route path="/applications/applicant/loan" element={<ApplicantLoanInfo />} />
        <Route path="/applications/applicant/prediction" element={<ApplicantPredInfo />} />
        <Route path="/applications/applicant/cashflow" element={<Cashflow />} />
        <Route path="/applications/applicant/previousloans" element={<PreviousLoans />} />
