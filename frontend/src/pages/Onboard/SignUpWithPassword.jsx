  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex " style={{ backgroundImage: `url(${BgImg})` }}>
      ...
      <form className="flex flex-col gap-5 mt-16">
        <div className=''>
          <label className='text-[#5F6D7E] font-semibold' htmlFor="firstName">First Name</label>
          <div>
            <input
          type="text"
        ...
        <div className=''>
          <label className='text-[#5F6D7E] font-semibold' htmlFor="surname">Surname</label>
          <div>
            <input
          type="text"
          placeholder="Surname"
        ...
        <div>
          <label className='text-[#5F6D7E] font-semibold' htmlFor="password">Password</label>
          <div>
          <input
          type="password"
          placeholder="**********"
        ...
        <div>
          <label className='text-[#5F6D7E] font-semibold' htmlFor="confirmPassword">Re-enter Password</label>
          <div>
          <input
          type="password"
          placeholder="**********"
