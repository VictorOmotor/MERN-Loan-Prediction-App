  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex " style={{ backgroundImage: `url(${BgImg})` }}>
      ...
      <form className="flex flex-col gap-5 mt-40">
        <div className=''>
          <label className='text-[#5F6D7E] font-semibold' htmlFor="securityQuestion">Select a Security Question</label>
          <div>
          <select
          type="text"
        ...
        >
        <option className='text-[#5F6D7E] font-semibold' value="option1">Option 1</option>
        <option className='text-[#5F6D7E] font-semibold' value="option2">Option 2</option>
        <option className='text-[#5F6D7E] font-semibold' value="option3">Option 3</option>
        <option className='text-[#5F6D7E] font-semibold' value="option4">Option 4</option>
        </select>
        </div>
        </div>
        <div className=''>
          <label className='text-[#5F6D7E] font-semibold' htmlFor="securityAnswer">Your Answer</label>
          <div>
          <input
          type="text"
          className="border border-[#5F6D7E] p-2 rounded-lg w-full focus:outline-none"
